...
require 'LLVMAssembly'
require 'UnparsePCC'
require 'GeneratePthread'
...
>>>>>>> 98ce9fbca939ef4caad6a285baff101e8e3fc331
if(ARGV[0] == "-p")	# Print the parse tree
    ...
    pthread = GeneratePthread.run tt
#	pthread.prettyprint STDOUT
	unparser = UnparsePCC.new
	unparser.unparse pthread
else
	puts "Help: Use"
	puts "-u : Unparse the prase tree"
	puts "-p : Print the parse tree"
	puts "-a : Print the llvm assembly code"
	puts "-omp : Generate the equivalent pthread code"
end
